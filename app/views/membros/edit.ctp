...
<?php echo $this->Form->create('Membro');?>
	<fieldset>
 		<legend><?php __('Edit Membro'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Membro.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Membro.id'))); ?></li>
