...
<?php echo $this->Form->create('ProjReport');?>
	<fieldset>
 		<legend><?php __('Edit Proj Report'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('ProjReport.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('ProjReport.id'))); ?></li>
